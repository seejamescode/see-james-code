...
const darkTheme = {
  ...
  colors: {
    ...
    backgroundShadowLarge: "5px 5px 15px #180619, -5px -5px 15px #180619",
    backgroundShadowHover: "0px 5px 10px #180619, 0px 5px 10px #180619",
    backgroundShadowHoverSmall: "5px 5px 15px #180619, -5px -5px 15px #180619",
...
const lightTheme = {
  ...
  colors: {
    ...
    backgroundShadowHover: "5px 5px 10px #d2d5d9, -5px 5px 10px #d2d5d9",
